...
if (!isset($_SESSION['nombre_cliente']) && !isset($_SESSION['descripcion_coche']) && !isset($_SESSION['fecha_actual'])) {
    ...
    $sel = $con->prepare("SELECT marca.marca_nombre, refaccion.refaccion_nombre, refaccion.refaccion_descripcion,
proveedor.proveedor_nombre, refaccion_proveedor.fecha_solicitud, refaccion_proveedor.precio,
refaccion_proveedor.refaccion_proveedor_id
FROM (marca INNER JOIN refaccion ON marca.marca_id = refaccion.marca_id) INNER JOIN (proveedor INNER JOIN refaccion_proveedor
ON proveedor.proveedor_id = refaccion_proveedor.id_proveedor) ON refaccion.refaccion_id = refaccion_proveedor.id_refaccion
GROUP BY marca.marca_nombre, refaccion.refaccion_nombre, refaccion.refaccion_descripcion, proveedor.proveedor_nombre,
refaccion_proveedor.fecha_solicitud, refaccion_proveedor.precio, refaccion_proveedor.refaccion_proveedor_id
