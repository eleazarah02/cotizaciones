    ...
    <body>
        ...
        <div class="container">
        	 <div class="jumbotron">
                ...
                HAVING marca.marca_nombre= \"". $nombre_marca_seleccionada . "\"
                    ...
                    <tbody>
                        <?php while ($f = $res->fetch_assoc()) { ?>
                            <tr>
                                ...
                                <td><a href="cotizacion_seleccionar_refaccion_detalles.php?refaccion_proveedor_id=<?php echo $f['refaccion_proveedor_id'] ?>">Seleccionar </a><span class="glyphicon glyphicon-handlef"></span>
                                </td>
                                </tr>
                                    <?php
                                    }
